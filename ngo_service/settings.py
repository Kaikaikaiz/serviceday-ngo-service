...
ALLOWED_HOSTS = os.environ.get('NGO_SERVICE_URL', '127.0.0.1 localhost').split()
...
MIDDLEWARE = [
    ...
    'ngo.middleware.RequestLogMiddleware',
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
       'ngo_service.authentication.StatelessJWTAuthentication',
